view: user_engagement_categories_residence {
  derived_table: {
    sql: with base as (select residence,retained_user,total_referrals,total_converted_referrals,on_time_payments_on_last_3_payments,
          ...
          PERCENTILE_CONT(0.25) OVER(ORDER BY Score) as score_25_percentile,
          PERCENTILE_CONT(0.50) OVER(ORDER BY Score) as score_50_percentile,
          PERCENTILE_CONT(0.75) OVER(ORDER BY Score) as score_75_percentile
          from
          (
