view: user_engagement_line_segment {
  derived_table: {
    sql: with base as (select student_id,residence,city, micromarket,retained_user,total_referrals,total_converted_referrals,on_time_payments_on_last_3_payments,
          ...
          1.00000*(coalesce(engagement.complaint_complaints_per_month,0)+coalesce(engagement.feedback_vas_order_rating,0)+
          ...
          1.00000*(coalesce(experience.complaint_complaints_per_month,0)+coalesce(experience.feedback_vas_order_rating,0)+
          ...
          1.00000*(coalesce(total.complaint_complaints_per_month,0)+coalesce(total.feedback_vas_order_rating,0)+
          ...
          1.00000*(avg(engagement) over(partition by micromarket)) as avg_engagement_micromarket,
          1.00000*(avg(engagement) over(partition by residence)) as avg_engagement_residence
