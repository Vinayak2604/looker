view: user_engagement_line_segment {
  derived_table: {
    sql: with base as (select student_id,residence,city, micromarket,retained_user,total_referrals,total_converted_referrals,on_time_payments_on_last_3_payments,
          ...
          case when engagement_score = 0.5 then 0 when engagement_score > 0.5 then '1' else '0' end as eng_score,
          ...
          case when experience_score = 0.5 then 0 when experience_score > 0.5 then '1' else '0' end as exp_score
