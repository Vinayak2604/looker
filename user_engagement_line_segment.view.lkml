view: user_engagement_line_segment {
  derived_table: {
    sql: with base as (select student_id,residence,city, micromarket,retained_user,total_referrals,total_converted_referrals,on_time_payments_on_last_3_payments,
          ...
          1.00*(coalesce(engagement.feedback_smr,0)+coalesce(engagement.transaction_preference_shared,0)+coalesce(engagement.vas_inernet_usage,0)+coalesce(engagement.vas_menu_opened,0)+coalesce(engagement.app_engagement_story,0)) / 12 engagement_score,
          ...
          coalesce(experience.feedback_meal_fps,0)+coalesce(experience.feedback_vas_fps,0)+
          coalesce(experience.loyalty_referred,0)+coalesce(experience.transaction_pays_rent_within_due_date,0)+
          coalesce(experience.transaction_meals_consumed,0)+coalesce(experience.vas_aov,0)+coalesce(experience.vas_no_of_orders,0)) / 31 experience_score,
          ...
          (coalesce(engagement.feedback_smr,0)+coalesce(engagement.transaction_preference_shared,0)+coalesce(engagement.vas_inernet_usage,0)+coalesce(engagement.vas_menu_opened,0)+coalesce(engagement.app_engagement_story,0)) engagement,
